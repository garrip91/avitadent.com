"""
Django settings for AvitaDentProject project.
...
SECRET_KEY = 'django-insecure-ie5j&vriqesi(1zkh4%&p_hycmcqqbk$*q4ew(h7(j(^e&^w@*'
...
ROOT_URLCONF = 'AvitaDentProject.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'AvitaDentApp.context_processors.get_actions_data',
                'AvitaDentApp.context_processors.get_reviews_data',
            ],
        },
    },
]

WSGI_APPLICATION = 'AvitaDentProject.wsgi.application'
